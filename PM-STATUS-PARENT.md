...
| T06 | BSP adapter interface + `1engage` impl                                           | A    | Nathan  | approved | PM A (H12)  | module `whatsapp`, vendor-agnostic port + factory 1engage adapter, ExternalServiceError, injected HttpPoster, 100% adapter cov. Awaiting PO merge. Consumed by T13+T16. Q-A-06 (B align module) |
