...
| T04 | Webhook signature-verification middleware (Meta `X-Hub-Signature-256` + Telegram)| A    | Nathan  | approved | PM A (H12)  | plugin-level preHandler, timingSafeEqual, raw-byte HMAC, 401 native, no-insert invariant proven, 100% line cov. Awaiting PO merge. Consumed by T12+T15+T19 |
