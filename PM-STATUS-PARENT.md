...
| T05 | Tenant resolution from `:hotel_slug` (LRU cache 5-min, hotels.code lookup)       | A    | Nathan  | approved | PM A (H12)  | factory TTL-LRU, injected lookup port (Q-A-01-agnostic per spec §4.3 L71), 404 native, never-trust-body proven, 100% resolver cov. Awaiting PO merge. Consumed by T12+T19 |
