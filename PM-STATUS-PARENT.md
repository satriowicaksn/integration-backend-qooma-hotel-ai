...
| T03 | Encryption-at-rest helper (AES-256-GCM or KMS for token columns)                 | A    | Nathan  | approved | PM A (H12)  | Opsi A current-version, 100% cov, tamper+fail-fast verified. Awaiting PO merge. **Foundation T01→T03 done.** Consumed by T10+T17 |
