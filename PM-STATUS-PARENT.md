...
| T17 | Telegram config CRUD (`GET, PUT /api/integrations/telegram`)                     | C    | Satrio  | wip      | PM C partial| PLAN a1 REJECT-scope-narrow (H13). Primitive proceeding; route+wiring blocked on Q-C-01/02/03/04 (foundation gaps: Prisma singleton, api.ts bootstrap, JWT plugin) |
